      ...
      <TableBody>
        {premiumPrizes.map((invoice) => (
          <TableRow key={invoice.place}>
            ...
            <TableCell className=""><div className='flex items-center justify-end space-x-3'> <img  src='/img/apt-logo.jpg'  className='w-6 h-6 rounded-full' /> <p>{invoice.price}</p></div></TableCell>
          </TableRow>
        ))}
      </TableBody>
